...
def PCA_method(formula):
    ...
    for j in range(1,14):
        ...
        if(formula == 'id3'):
            ...
            print("Ty le du doan dung ID3: ", rate*100)
            if(rate > max):
                num_pca = j
                pca_best = pca
                max = rate
...
lable_people.config(bg="#a9eefe")
# THÔNG TIN CỘT 1
lable_age = Label(form,font=("Arial Bold", 10), text = "Tuổi:" ,bg="#a9eefe").place(x = 180 , y = 50)
textbox_age = Entry(form,width = 30,font=("Arial Bold", 10))
textbox_age.place(x = 410 , y = 50)

lable_sex = Label(form,font=("Arial Bold", 10), text = "Giới tính:" ,bg="#a9eefe").place(x = 180 , y = 90)
...
lable_cp = Label(form,font=("Arial Bold", 10), text = "Loại đau ngực:",bg="#a9eefe").place(x = 180 , y = 130)
...
lable_trestbps = Label(form,font=("Arial Bold", 10), text = "Huyết áp khi nghỉ ngơi(mm/Hg):",bg="#a9eefe").place(x = 180 , y = 170)
textbox_trestbps = Entry(form,width = 30,font=("Arial Bold", 10))
textbox_trestbps.place(x = 410 , y = 170)

lable_chol = Label(form,font=("Arial Bold", 10), text = "Cholesterol(mg/dl):",bg="#a9eefe").place(x = 180 , y = 210)
textbox_chol = Entry(form,width = 30,font=("Arial Bold", 10))
textbox_chol.place(x = 410 , y = 210)

lable_fbs = Label(form,font=("Arial Bold", 10), text = "Lượng đường trong máu: ",bg="#a9eefe").place(x = 180 , y = 250)
...
lable_restecg = Label(form,font=("Arial Bold", 10), text = "Điện tâm đồ khi nghỉ ngơi:",bg="#a9eefe").place(x = 180 , y = 290)
...
# THÔNG TIN CỘT 2
lable_thalach = Label(form,font=("Arial Bold", 10), text = "Số nhịp đập mỗi phút:",bg="#a9eefe").place(x = 830 , y = 50)
textbox_thalach = Entry(form,width = 30,font=("Arial Bold", 10))
textbox_thalach.place(x = 1080 , y = 50)

lable_exang = Label(form,font=("Arial Bold", 10), text = "Tập thể dục gây ra đau thắt ngực:",bg="#a9eefe").place(x = 830 , y = 90)
...
lable_oldpeak = Label(form,font=("Arial Bold", 10), text = "ST trầm cảm:",bg="#a9eefe").place(x = 830 , y = 130)
textbox_oldpeak = Entry(form,width = 30,font=("Arial Bold", 10))
textbox_oldpeak.place(x = 1080 , y = 130)

lable_slope = Label(form,font=("Arial Bold", 10), text = "Độ dốc của đoạn ST:",bg="#a9eefe").place(x = 830 , y = 170)
...
lable_ca = Label(form,font=("Arial Bold", 10), text = "Số mạch chính:",bg="#a9eefe").place(x = 830 , y = 210)
...
lable_thal = Label(form,font=("Arial Bold", 10), text = "Thalassemia:",bg="#a9eefe").place(x = 830 , y = 250)
...
lable_note = Label(form, text = "Khi chưa sử dụng PCA",font=("Arial Bold", 13),fg="blue",bg="#a9eefe").place(x = 410 , y = 500)

#ID3
#dudoanid3test
y_id3 = id3.predict(X_test_main)
lbl3 = Label(form,font=("Arial Bold", 10),bg="#a9eefe")
...
#khi dung PCA
lable_note = Label(form, text = "Khi sử dụng PCA",font=("Arial Bold", 13),fg="blue",bg="#a9eefe").place(x = 930 , y = 500)
...
lbl1 = Label(form, text="",font=("Arial Bold", 10),fg="blue",bg="#a9eefe")
...
lbl1_id3pca = Label(form, text="",font=("Arial Bold", 10),fg="blue",bg="#a9eefe")
